...
const InstructionMap instr_table[] = {
    ...
    {"b", Instr::B},       {"beq", Instr::BEQ},     {"bge", Instr::BGE},
    {"bgt", Instr::BGT},   {"bl", Instr::BL},       {"ble", Instr::BLE},
    {"blt", Instr::BLT},   {"bne", Instr::BNE},     {"cbnz", Instr::CBNZ},
    {"cbz", Instr::CBZ},   {"cmp", Instr::CMP},     {"ldr", Instr::LDR},
    {"ldrb", Instr::LDRB}, {"lsl", Instr::LSL},     {"lsls", Instr::LSLS},
    {"lsr", Instr::LSR},   {"lsrs", Instr::LSRS},   {"mov", Instr::MOV},
    {"mul", Instr::MUL},   {"muls", Instr::MULS},   {"not", Instr::NOT},
    {"orr", Instr::ORR},   {"orrs", Instr::ORRS},   {"ret", Instr::RET},
    {"sdiv", Instr::SDIV}, {"sdivs", Instr::SDIVS}, {"str", Instr::STR},
    {"strb", Instr::STRB}, {"sub", Instr::SUB},     {"subs", Instr::SUBS},
